...
public class SseController(IEventBufferService eventBuffer, ILogger<SseController> logger, ITaskProgress taskProgress) : AbpController
{
    ...
    private readonly ITaskProgress _taskProgress = taskProgress;
    ...
    {
        return TypedResults.ServerSentEvents(
            _taskProgress.GenerateProgressStream(taskName, 
                [@"C:\Users\ke\dev\proj\tools\BeeChat\ChatApi\host\Ke.Chat.HttpApi.Host\FodyWeavers.xml"], 
                lastEventId))
                ;
    }
